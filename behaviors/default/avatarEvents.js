class AvatarPawn {
    setup() {
        ...
        console.log('Subscribing to jumpToTargetWorld: ', this.viewId)

        this.subscribe('global', 'jumpToTargetWorld', 'jumpToTargetWorld') 
    }

    jumpToTargetWorld(data) {
        const {viewId, targetURL} = data;
