...
class SpideyJumpOnApproachActor {
    ...
    step() {
        ...
        if (avatars.length > 0) {
            ...
            if (minDistance < this.animationProximateDistance){
                ...
                this._cardData.jumped = true;
                this.future(this._cardData.delayAfterJump).setFinal();
            } else {
                this._cardData.animationClipIndex = this.animationDistantAnimationClip;
                this.future(this.animationCheckInterval).step();
            }
...
export default {
    modules: [
        {
            name: "SpideyJumpOnApproach",
            actorBehaviors: [SpideyJumpOnApproachActor],
        }
    ]
}
