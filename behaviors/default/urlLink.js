...
class URLPawn {
    ...
    tap() {
        ...
        let targetString = this.actor._cardData.reuseTab?"":' target="_blank"'
        console.log(url);
        div.innerHTML = `<a id="link"' ${targetString} rel="noopener noreferrer" href="${url}"></a>`;
